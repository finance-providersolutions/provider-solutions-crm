...
// Opp. Contact's Details still sits inside the older bg-surface
// card wrapper + SectionHeader (the DetailsCollapsibleHeader
// migration is a separate cluster-A decision). The DetailGrid shape
// inside the wrapper is the same horizontal pattern.
