...
// V4 — synthesis of V2 + V3 with three targeted improvements:
//   1. Top KPI row from V3 — six drillable cards. Drill targets are
//      unfiltered list pages because no list page reads URL filter
//      state today (probed; not building list-filtering this pass).
//   2. State Match REWORKED — demand-states only (drop latent), per-
//      state Level-2 cards with three explicit stacked bars (supply,
//      open, filled). Win/retain split visible regardless of width.
//   3. Retention REFRAMED — per-contract health list naming the
//      at-risk thing ("Bob Anderson's privilege expires in 80 days")
//      instead of V2's abstract tier counts.
...
export default function HomeV4() {
  ...
  return (
    <>
      ...
      <SectionHeader text="State Match" first />
